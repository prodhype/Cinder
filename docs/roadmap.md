...
Other plausible additions include inline or inferred closure syntax, bound method closure values, richer match patterns, package dependencies, interface bounds on type parameters, and a documented stable C ABI for selected exported declarations.
